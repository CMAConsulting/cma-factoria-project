---
name: scout
description: Investigador de código. Úsalo para analizar el repositorio, mapear dependencias y generar un SPEC.md con especificaciones técnicas antes de implementar. No escribe código de implementación. Invócalo al inicio de cualquier tarea de análisis o cuando necesites entender el estado actual del proyecto.
